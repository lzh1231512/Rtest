    ...
    public class WebPage
    {
        ...
        private void Init(string _url)
        {
            try
            {
                ...
                rqst.UserAgent = "Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko";
                rqst.KeepAlive = true;
                rqst.Timeout = 30000;
                ...
                if (rsps.ContentLength > 1 << 22)
                {
                    rsps.Close();
                    m_good = false;
                    return;
                }
                Encoding cding = System.Text.Encoding.UTF8;
